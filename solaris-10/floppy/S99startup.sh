...
/usr/sfw/bin/wget http://www.sudo.ws/sudo/dist/packages/Solaris/10/TCMsudo-1.8.23-i386.pkg.gz --no-check-certificate
gunzip TCMsudo-1.8.23-i386.pkg.gz
pkgadd -a /tmp/noask -d TCMsudo-1.8.23-i386.pkg all
